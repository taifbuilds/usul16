...
const ar: Dictionary = {
  ...
  hero: {
    ...
    subtitle:
      "الكتب الأربعة وما تلاها من المصنَّفات. كلّ روايةٍ موصولةٌ بصفحتها المطبوعة.",
    hint1: "عربي وإنجليزي",
  ...
  evidence: {
    ...
    item3Body: "كلّ اسمٍ موصولٌ بترجمة راويه، مع دليل التعيين.",
    item4Title: "التحمُّل والرواية",
    item4Body: "كيف يترابط الرواة، رجوعًا إلى الروايات التي تُثبت كلّ صلة.",
    item5Title: "الإحالة",
