...
This register is a public-launch gate. A source being publicly readable does
not by itself establish permission to mirror or redistribute it.
...
Before public launch, attach dated evidence or correspondence to each row,
record the required attribution in the interface, and have the final position
reviewed by a qualified adviser. This file is an operational checklist, not a
legal conclusion.
